...
# With Upload Logs, Charts, Live Map & Geo-IP Lookup
# =================================================
...
# ================================================
# 4. Geo-IP Resolution (Hybrid)
# ================================================
# Local mapping for private/demo IPs
geo_map = {
    "10.0.0.1": (38.0, -97.0),   # USA
    "192.168.1.5": (51.5, -0.1), # UK
}

# Try resolving IPs with live Geo-IP lookup
def resolve_ip(ip):
    try:
...
alerts["lat"], alerts["lon"] = zip(*alerts["source_ip"].map(get_coordinates))
