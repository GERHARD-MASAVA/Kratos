...
# -----------------------
IPINFO_TOKEN = "YOUR_TOKEN_HERE"  # paste your token here
...
# -----------------------
# Threat Intel News tab
# -----------------------
with tab5:
    st.header("📰 Threat Intelligence News")

    auto_refresh_news = st.sidebar.checkbox("🔄 Auto-refresh News (every 5 min)", value=False)

    if auto_refresh_news:
        time.sleep(300)  # wait 5 minutes then refresh
        st.rerun()

    try:
        url = "https://newsapi.org/v2/everything?q=cybersecurity&apiKey=5eb57893abfb4d54b2c2036ee2a21991"
        ...
        st.info("Tip: Get a free API key from https://newsapi.org and paste it above.")
